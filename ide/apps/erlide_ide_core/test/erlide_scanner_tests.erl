...
scanner_light_scan_string_test_() ->
    [
        ?_assertEqual(
            {ok, <<?TOK_ATOM, 0:24, 0:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"a">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_ATOM, 0:24, 0:24, 3:24>>},
            erlide_scanner:light_scan_string(<<"'a'">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<$(, 0:24, 0:24, 1:24>>},
        ...
        ?_assertEqual(
            {ok, <<?TOK_STR, 0:24, 0:24, 3:24>>},
            erlide_scanner:light_scan_string(<<"\"a\"">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_VAR, 0:24, 0:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"A">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_CHAR, 0:24, 0:24, 2:24>>},
            erlide_scanner:light_scan_string(<<"$a">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_CHAR, 0:24, 0:24, 3:24>>},
        ...
        ?_assertEqual(
            {ok, <<?TOK_CHAR, 0:24, 0:24, 5:24>>},
            erlide_scanner:light_scan_string(<<"$\\122">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_CHAR, 0:24, 0:24, 9:24>>},
        ...
        ?_assertEqual(
            {ok, <<?TOK_INTEGER, 0:24, 0:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"1">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_FLOAT, 0:24, 0:24, 3:24>>},
            erlide_scanner:light_scan_string(<<"1.1">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_FLOAT, 0:24, 0:24, 5:24>>},
            erlide_scanner:light_scan_string(<<"1.1e3">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_KEYWORD, 0:24, 0:24, 3:24>>},
            erlide_scanner:light_scan_string(<<"end">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_ATOM, 0:24, 0:24, 5:24>>},
            erlide_scanner:light_scan_string(<<"'end'">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_ATOM, 0:24, 0:24, 1:24, ?TOK_OTHER, 0:24, 1:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"a.">>, latin1)
        ),
        ?_assertEqual(
            {ok,
                <<?TOK_WS, 0:24, 0:24, 2:24, ?TOK_WS, 0:24, 2:24, 1:24, ?TOK_WS, 0:24, 3:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"  \t ">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_ARROW, 0:24, 0:24, 2:24>>},
            erlide_scanner:light_scan_string(<<"->">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_MACRO, 0:24, 0:24, 3:24>>},
        ...
        ?_assertEqual(
            {ok, <<?TOK_MACRO, 0:24, 0:24, 4:24>>},
            erlide_scanner:light_scan_string(<<"??hi">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_COMMENT, 0:24, 0:24, 2:24>>},
            erlide_scanner:light_scan_string(<<"%b">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_COMMENT, 0:24, 0:24, 2:24, ?TOK_WS, 0:24, 2:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"%b\n">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_WS, 0:24, 0:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"\n">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_WS, 0:24, 0:24, 2:24>>},
            erlide_scanner:light_scan_string(<<"\n ">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_WS, 0:24, 0:24, 2:24, ?TOK_WS, 1:24, 2:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"\n \n">>, latin1)
        ),
        ?_assertEqual(
            {ok, <<?TOK_WS, 0:24, 0:24, 1:24, ?TOK_ATOM, 1:24, 1:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"\nc">>, latin1)
        ),
        ?_assertEqual(
            {ok,
        ...
        ?_assertEqual(
            {ok,
                <<?TOK_ATOM, 0:24, 0:24, 1:24, $(, 0:24, 1:24, 1:24, $), 0:24, 2:24, 1:24, ?TOK_WS,
                    0:24, 3:24, 1:24, ?TOK_ARROW, 0:24, 4:24, 2:24, ?TOK_WS, 0:24, 6:24, 1:24,
                    ?TOK_ATOM, 0:24, 7:24, 1:24, ?TOK_OTHER, 0:24, 8:24, 1:24>>},
            erlide_scanner:light_scan_string(<<"a() -> b.">>, latin1)
        ),
        ?_assertEqual(
            {ok,
                <<?TOK_ATOM, 0:24, 0:24, 1:24, $(, 0:24, 1:24, 1:24, $), 0:24, 2:24, 1:24, ?TOK_WS,
                    0:24, 3:24, 1:24, ?TOK_ARROW, 0:24, 4:24, 2:24, ?TOK_WS, 0:24, 6:24, 2:24,
                    ?TOK_ATOM, 1:24, 8:24, 1:24, ?TOK_OTHER, 1:24, 9:24, 1:24>>},
...
scanner_test_() ->
    [
        ?_assertEqual(
            [
                #token{kind = atom, line = 0, offset = 0, length = 1, value = a, text = "a"},
        ...
        ?_assertEqual(
            {
                ...
                [
                    #token{
                        kind = atom, line = 0, offset = 0, length = 4, value = test, text = "test"
                    },
...
replace_at_eof_test_() ->
    [
        ?_assertEqual(
            {[#token{kind = atom, line = 0, offset = 0, length = 2, value = ab, text = "ab"}], [
...
newline_char_test_() ->
    [
        ?_assertEqual(
            [
                #token{kind = '[', line = 0, offset = 0, length = 1, text = "["},
        ...
        ?_assertEqual(
            {ok,
                [
                    #token{kind = '[', line = 0, offset = 0, length = 1, text = "["},
                    #token{
                        kind = char, line = 0, offset = 1, length = 3, text = "$\\n", value = 10
                    },
                    #token{kind = ']', line = 0, offset = 4, length = 1, text = "]"}
                ],
                {0, 6, 5}},
