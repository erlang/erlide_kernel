...
relative_pos(Offset1, Length1, Offset2, Length2) when
    Offset1 >= Offset2, Offset1 + Length1 =< Offset2 + Length2
->
    within;
relative_pos(Offset1, Length1, Offset2, _Length2) when
    Offset1 + Length1 =< Offset2
->
    before;
relative_pos(Offset1, _Length1, Offset2, Length2) when
